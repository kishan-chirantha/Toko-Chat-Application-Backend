...
public class ProfileService {
    ...
    public static String getProfileUrl(int userId) {
        try {
            ...
            URL url = new URI("http://localhost:8080/TokoApp/profile-images/" + userId + "/profile1.png").toURL(); // java.net.URL
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                profile = ChatService.URL+ "/TokoApp/profile-images/" + userId + "/profile1.png";
            } else {
                profile = "";
            }
            return profile;
